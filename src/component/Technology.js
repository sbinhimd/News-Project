...
export default class Technology extends Component {
  ...
  componentDidMount() {
    ...
    axios
      .get(
        "https://newsapi.org/v2/top-headlines?country=us&pageSize=35&category=technology&apiKey=7a1908d04c2740e7924b15b67514f428"
      )
  ...
  render() {
    ...
    return (
      <div>
        <h2>{` Search Results for Technology Category `}</h2>
